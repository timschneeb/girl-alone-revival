...
namespace GirlAloneServer.Core.Migrations
{
    ...
    [Migration("20241110225458_add_login_data")]
    partial class add_login_data
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GirlAloneServer.Core.Model.LoginData", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.HasKey("UserId")
                        .HasName("LD_UserId_pk");

                    b.HasIndex(new[] { "UserId" }, "LD_UserId_gin");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex(new[] { "UserId" }, "LD_UserId_gin"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex(new[] { "UserId" }, "LD_UserId_gin"), new[] { "gin_trgm_ops" });
